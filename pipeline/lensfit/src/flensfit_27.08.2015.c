...
#define DATE_STRING "$LastChangedDate$"
#define REV_STRING "$Rev$"
    ...
    */
    ...
    if (fitclass[i]==0)
      ...
      sprintf(output_string[i],
        ...
        meanpsfe[0], meanpsfe[1], meanstrehl, fprob[i], rmar[i]-rdata,
        gvariance, emod, creal(ecorr-edata), cimag(ecorr-edata),
