...
SVN Revision $Rev: 232 $ 
last changed by $Author: miller $
on $LastChangedDate: 2014-02-13 15:08:10 +0100 (Thu, 13 Feb 2014) $

--------------------------------------------------------------*/

#define DATE_STRING "$LastChangedDate: 2014-02-13 15:08:10 +0100 (Thu, 13 Feb 2014) $"
#define REV_STRING "$Rev: 232 $"
...
#define WRITE_POSTERIOR_SURFACES 0
