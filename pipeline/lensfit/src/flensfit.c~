...
SVN Revision $Rev: 273 $ 
last changed by $Author: miller $
on $LastChangedDate: 2015-09-09 23:34:12 +0100 (Wed, 09 Sep 2015) $
...
#define DATE_STRING "$LastChangedDate: 2015-09-09 23:34:12 +0100 (Wed, 09 Sep 2015) $"
#define REV_STRING "$Rev: 273 $"
...
/*  read command-line and test the input arguments  */
    ...
    */
	...
	if (strncmp(cameraenv,"kids",1)==0 || strncmp(cameraenv,"KIDS",1)==0) {
	  ...
	  if (strncmp(cameraenv,"c",1)==0 || strncmp(cameraenv,"C",1)==0) {
	    cfht = 1;
	    printf(" setting up for CFHT (Megacam) camera\n");
	  } else {
...
/* read the input catalogue */
    ...
    for (i=0; i<nobj; i++) output_string[i] = (char*) calloc(255, sizeof(char));
    temp_string = (char*)calloc(255, sizeof(char));
		...
		if (skip_fitting==1)
		  {
		    ...
		    "%10.6lf %10.6lf %7.4f %7.4f %7.4f %2d %7.4f %6.4f %8.1f %8.1f %8.6f %6.2f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %5.2f %5.2f %5.2f %3d %8d", 
			    wcsx[i], wcsy[i], 0., 0., 0.,
