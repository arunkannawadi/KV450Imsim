...
# work through the data for each of four rotations
    for i in range(1):
...
#  work through data and apply correction
        ...
        output.write('# 30  original weight\n')
...
#  remove the autocalibration correction except when this is invalid at |e|=efunc_emax
                    ...
                    if weight>0:
                        ...
                        vals[4] = weight
                k+=1
                output_string = "%10.6lf %10.6lf %7.4f %7.4f %7.4f %2d %7.4f %6.4f %8.1f %8.1f %8.6f %6.2f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %7.4f %5.2f %5.2f %5.2f %3d %8d %7.4f\n" % (vals[0], vals[1], vals[2], vals[3], vals[4], vals[5], vals[6], vals[7], vals[8], vals[9], vals[10], vals[11], vals[12], vals[13], vals[14], vals[15], vals[16], vals[17], vals[18], vals[19], vals[20], vals[21], vals[22], vals[23], vals[24], vals[25], vals[26], vals[27], vals[28], oldweight)
