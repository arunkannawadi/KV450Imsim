...
#AKJ: Where do the fields below come from???
            ...
            e1_LF=sim[:,2]#tbdata_sim['bias-corrected <e1>']
            e2_LF=sim[:,3]#tbdata_sim['bias-corrected <e2>']
            SNR_LF=sim[:,10]#tbdata_sim['model SNratio']
            mode_LF=sim[:,21]#tbdata_sim['mean-likelihood |e|']
            oldw_LF=sim[:,29]
            w_LF=sim[:,4]#tbdata_sim.weight
            size_LF=sim[:,6]#tbdata_sim['bias-corrected scalelength /pixels']
            ...
            rcorr=sim[:,19]#tbdata_sim['r correction']
            e1_corr=sim[:,22]#tbdata_sim['e1 correction']
            e2_corr=sim[:,23]#tbdata_sim['e2 correction']
