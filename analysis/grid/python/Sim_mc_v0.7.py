...
argopts.add_option("-r", "--results", dest="resultsDir",
                    default="Results",
                    type="string",
                    help="Specify the relative path of Results folder")
...
if(not(os.path.isdir(Dir+"./"+resultsDir))):
    os.mkdir(Dir+"./"+resultsDir)

if(not(os.path.isdir(Dir+"./"+resultsDir+"/1bin"))):
    os.mkdir(Dir+"./"+resultsDir+"/1bin")

if(not(os.path.isdir(Dir+"./"+resultsDir+"/2bin"))):
    os.mkdir(Dir+"./"+resultsDir+"/2bin")
...
if(os.path.exists(file)):
    ...
    if not goldflag=='nogold':
        SOM_cuts = fits_data[1].data['Flag_SOM_{}_NONE'.format(goldflag)]==1
    else:
        SOM_cuts = True
...
if(spline==True):
    ...
    if(spline2==True):
        if(m_func =='none'):
            string_start=Dir+'/'+resultsDir+'/1bin/'+Flag+"_"+str(Psf_set)+'_100_'
...
#    e2_sim_mask = e2_true
    ...
    if(len(ObsBin)>1):
        ...
        if(spline==True):
            if(spline2==True):
                DoAll(ObsType[kk],ObsBin, obs_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100),-99,file_ending,cal1,cal2,None,None,None,None,None,None,None,None,None,None,m1_splines, m2_splines,c1_splines, c2_splines)
            elif(spline_multi==True):
                #DoAll(ObsType[kk],ObsBin, obs_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100),-99,file_ending,cal1,cal2,None,None,None,None,None,None,m1_splines, m2_splines,c1_splines, c2_splines, spline_thresholds,mag_sim_weight,mag_spline1,mag_spline2)
                DoAll(ObsType[kk],ObsBin, obs_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100),-99,file_ending,cal1,cal2,None,None,None,None,None,None,None,None,None,None,m1_splines, m2_splines,c1_splines, c2_splines, spline_thresholds)
            else:
                DoAll(ObsType[kk],ObsBin, obs_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100),-99,file_ending,cal1,cal2,None,None,None,None,None,None,None,None,None,None,m1_splines, m2_splines,c1_splines, c2_splines)
#        elif(function==True):
#            DoAll(ObsType[kk],ObsBin, obs_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100),-99,file_ending,cal1,cal2,None,None,None,None,func_m,m1_params,m2_params,func_c,c1_params,c2_params)
        elif(table_cal==True):
            print "Doing this."
            DoAll(ObsType[kk],ObsBin, obs_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100),-99,file_ending,cal1,cal2,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,m1_table,m2_table,c1_table,c2_table,shift_x,shift_y,scale_x, scale_y,Tree)
        elif(bin_cal==True):
            print "Doing this."
            DoAll(ObsType[kk],ObsBin, obs_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100),-99,file_ending,cal1,cal2,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,table_data)
        elif(file_cal==True):
            DoAll(ObsType[kk],ObsBin, obs_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100),-99,file_ending,cal1,cal2,m1_sim_weight,m2_sim_weight,c1_sim_weight,c2_sim_weight,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
        else:
            DoAll(ObsType[kk],ObsBin, obs_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100),-99,file_ending)
    ...
    if(sep_strehl_flag=='Yes' or sep_strehl_flag=='Y' or sep_strehl_flag=='True' or  sep_strehl_flag=='yes' or sep_strehl_flag=='y' or sep_strehl_flag=='true'):
        ...
        for gg in range(0, Nunique-1):
            ...
            if(len(ObsBin_set)>1):
                ...
                if(spline==True):
                    if(spline2==True):
                        DoAll(ObsType[kk],ObsBin_set, obs_sim_weight[mask_gg], w_sim_mask[mask_gg], e1_sim_mask[maskgg], e2_sim_mask[mask_gg], e1_in_sim_weight[mask_gg], e2_in_sim_weight[mask_gg], e1_corr_sim_weight[mask_gg],e2_corr_sim_weight[mask_gg], g1_in_mask[mask_gg],g2_in_mask[mask_gg], g1_theo, g2_theo, fileOut, Flag, PlotName, ObsLabel,psf_e1_sim_weight[mask_gg],psf_e2_sim_weight[mask_gg],psf_size_sim_weight[mask_gg],Dir,resultsDir,TotWeight,Psf_set, name_add,strehl_set,file_ending,cal1,cal2,None,None,None,None,None,None,None,None,None,None,m1_splines, m2_splines,c1_splines, c2_splines)
                    elif(spline_multi==True):
                        #DoAll(ObsType[kk],ObsBin, obs_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100),-99,file_ending,cal1,cal2,None,None,None,None,None,None,m1_splines, m2_splines,c1_splines, c2_splines, spline_thresholds,mag_sim_weight,mag_spline1,mag_spline2)
                        DoAll(ObsType[kk],ObsBin, obs_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set,name_add,strehl_set,file_ending,cal1,cal2,None,None,None,None,None,None,None,None,None,None,m1_splines, m2_splines,c1_splines, c2_splines, spline_thresholds)
                    else:
...
#                elif(function==True):
#                    DoAll(ObsType[kk],ObsBin_set, obs_sim_weight[mask_gg], w_sim_mask[mask_gg], e1_sim_mask[mask_gg], e2_sim_mask[mask_gg], e1_in_sim_weight[mask_gg], e2_in_sim_weight[mask_gg], e1_corr_sim_weight[mask_gg],e2_corr_sim_weight[mask_gg], g1_in_mask[mask_gg],g2_in_mask[mask_gg], g1_theo, g2_theo, fileOut, Flag, PlotName, ObsLabel,psf_e1_sim_weight[mask_gg],psf_e2_sim_weight[mask_gg],psf_size_sim_weight[mask_gg],Dir,resultsDir,TotWeight,Psf_set,name_add,strehl_set,file_ending,cal1,cal2,None,None,None,None,func_m,m1_params,m2_params,func_c,c1_params,c2_params)
                elif(table_cal==True):
                    DoAll(ObsType[kk],ObsBin, obs_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set,name_add,strehl_set,file_ending,cal1,cal2,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,m1_table,m2_table,c1_table,c2_table,shift_x,shift_y,scale_x, scale_y,Tree)
                elif(bin_cal==True):
                    DoAll(ObsType[kk],ObsBin, obs_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set,name_add,strehl_set,file_ending,cal1,cal2,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,table_data)
                elif(file_cal==True):
                    DoAll(ObsType[kk],ObsBin, obs_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set,name_add,strehl_set,file_ending,cal1,cal2,m1_sim_weight,m2_sim_weight,c1_sim_weight,c2_sim_weight,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
                else:
                    DoAll(ObsType[kk],ObsBin_set, obs_sim_weight[mask_gg], w_sim_mask[mask_gg], e1_sim_mask[mask_gg], e2_sim_mask[mask_gg], e1_in_sim_weight[mask_gg], e2_in_sim_weight[mask_gg], e1_corr_sim_weight[mask_gg],e2_corr_sim_weight[mask_gg], g1_in_mask[mask_gg],g2_in_mask[mask_gg], g1_theo, g2_theo, fileOut, Flag, PlotName, ObsLabel,psf_e1_sim_weight[mask_gg],psf_e2_sim_weight[mask_gg],psf_size_sim_weight[mask_gg],Dir,resultsDir,TotWeight,Psf_set,name_add,strehl_set,file_ending)
...
for kk in range(len(ObsType)):
    ...
    if(spline==True):
        if(spline2==True):
            DoAll2Bins(ObsType[kk],bins2D,obs_sim_weight_1,obs_sim_weight_2,mag_in_sim_weight, size_in_sim_alt_weight, mag_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel_1, ObsLabel_2,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100), Nbin,-99,file_ending,cal1,cal2,None,None,None,None,None,None,m1_splines, m2_splines,c1_splines, c2_splines)
        elif(spline_multi==True):
            #DoAll2Bins(ObsType[kk],bins2D,obs_sim_weight_1,obs_sim_weight_2, mag_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel_1, ObsLabel_2,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100), Nbin,-99,file_ending,cal1,cal2,None,None,None,None,None,None,m1_splines, m2_splines,c1_splines, c2_splines,spline_thresholds,mag_spline1,mag_spline2)
            DoAll2Bins(ObsType[kk],bins2D,obs_sim_weight_1,obs_sim_weight_2, mag_in_sim_weight, size_in_sim_alt_weight, mag_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel_1, ObsLabel_2,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100), Nbin,-99,file_ending,cal1,cal2,None,None,None,None,None,None,None,None,None,None,m1_splines, m2_splines,c1_splines, c2_splines,spline_thresholds)
        else:
            DoAll2Bins(ObsType[kk],bins2D,obs_sim_weight_1,obs_sim_weight_2,mag_in_sim_weight, size_in_sim_alt_weight, mag_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel_1, ObsLabel_2,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100), Nbin,-99,file_ending,cal1,cal2,None,None,None,None,None,None,None,None,None,None,m1_splines, m2_splines,c1_splines, c2_splines)
#    elif(function==True):
#        DoAll2Bins(ObsType[kk],bins2D,obs_sim_weight_1,obs_sim_weight_2,mag_in_sim_weight, mag_sim_weight, size_in_sim_alt_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel_1, ObsLabel_2,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100), Nbin,-99,file_ending,cal1,cal2,None,None,None,None,func_m,m1_params,m2_params,func_c,c1_params,c2_params)
    elif(table_cal):
        print "Doing This"
        DoAll2Bins(ObsType[kk],bins2D,obs_sim_weight_1,obs_sim_weight_2,mag_in_sim_weight, size_in_sim_alt_weight, mag_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel_1, ObsLabel_2,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100), Nbin,-99,file_ending,cal1,cal2,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,m1_table,m2_table,c1_table,c2_table,shift_x,shift_y,scale_x, scale_y,Tree)
    elif(bin_cal):
        print "Doing This"
        DoAll2Bins(ObsType[kk],bins2D,obs_sim_weight_1,obs_sim_weight_2,mag_in_sim_weight, size_in_sim_alt_weight, mag_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel_1, ObsLabel_2,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100), Nbin,-99,file_ending,cal1,cal2,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,table_data)
    elif(file_cal):
        print "Doing This"
        DoAll2Bins(ObsType[kk],bins2D,obs_sim_weight_1,obs_sim_weight_2,mag_in_sim_weight, size_in_sim_alt_weight, mag_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel_1, ObsLabel_2,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100), Nbin,-99,file_ending,cal1,cal2,m1_sim_weight,m2_sim_weight,c1_sim_weight,c2_sim_weight,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
    else:
        DoAll2Bins(ObsType[kk],bins2D,obs_sim_weight_1,obs_sim_weight_2,mag_in_sim_weight, size_in_sim_alt_weight,mag_sim_weight, w_sim_mask, e1_sim_mask, e2_sim_mask, e1_in_sim_weight, e2_in_sim_weight, e1_corr_sim_weight,e2_corr_sim_weight, g1_in_mask,g2_in_mask, g1_theo, g2_theo, fileOutAll, Flag, PlotNameAll, ObsLabel_1, ObsLabel_2,psf_e1_sim_weight,psf_e2_sim_weight,psf_size_sim_weight,Dir,resultsDir,TotWeight,Psf_set, str(100), Nbin,-99,file_ending)
